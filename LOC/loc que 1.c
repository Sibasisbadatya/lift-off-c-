...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" src="./loc que 1_files/shares.json"></script><script type="text/javascript" src="./loc que 1_files/shares(1).json"></script><script type="text/javascript" async="" src="./loc que 1_files/analytics.js.download"></script><script type="text/javascript" src="./loc que 1_files/1.txt"></script><script type="text/javascript" src="./loc que 1_files/1(1).txt"></script><script type="text/javascript" async="" src="./loc que 1_files/js"></script><script type="text/javascript" src="./loc que 1_files/moatframe.js.download"></script>
...
<center>
    ...
    <script async="" type="text/javascript" src="./loc que 1_files/carbon.js.download" id="_carbonads_js"></script> 
...
<script src="./loc que 1_files/jquery.dataTables.min.js.download" defer=""></script>
<link rel="stylesheet" href="./loc que 1_files/jquery.dataTables.min.css">

<script src="./loc que 1_files/dataTables.rowReorder.js.download" defer=""></script>

<iframe id="my_iframe" style="display:none;" src="./loc que 1_files/saved_resource.html"></iframe>
<script>
...
<div class="list-group col-sm-10 col-sm-offset-1">
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
                ...
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/nvoSuZKAT" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">lift off c que 1</a></td>
                <td>Project</td>
                <td>
...
<script async="" src="./loc que 1_files/js(1)"></script>
<script>
...
-->
        <!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="./loc que 1_files/addthis_widget.js.download"></script><div id="_atssh" style="visibility: hidden; height: 1px; width: 1px; position: absolute; top: -9999px; z-index: 100000;"><iframe id="_atssh228" title="AddThis utility frame" style="height: 1px; width: 1px; position: absolute; top: 0px; z-index: 100000; border: 0px; left: 0px;" src="./loc que 1_files/sh.f48a1a04fe8dbf021b4cda1d.html"></iframe></div><style id="service-icons-0"></style> 
...
<iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame" src="./loc que 1_files/box-acca23410e696f2ca3087d947271c3d0.html" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe></body></html>