<!DOCTYPE html>
<!-- saved from url=(0033)https://www.onlinegdb.com/myfiles -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" src="./loc que_files/shares.json"></script><script type="text/javascript" src="./loc que_files/shares(1).json"></script><script type="text/javascript" async="" src="./loc que_files/analytics.js.download"></script><script type="text/javascript" src="./loc que_files/1.txt"></script><script type="text/javascript" src="./loc que_files/1(1).txt"></script><script type="text/javascript" async="" src="./loc que_files/js"></script><script type="text/javascript" src="./loc que_files/moatframe.js.download"></script>
    <title>My Projects | GDB online Debugger </title>
    ...
    <div class="split-pane-component " id="left-component" style="background-color: #125792;">
        <div style="background-color: #125792; padding:10px 0px 0px 0px">
          ...
          <div style="text-align: center;    color: #ccd7dd;    padding: 10px 0px;    font-style: italic;    border-top: 1px solid #658a9e;    border-bottom: 1px solid #658a9e;">
              ...
              Welcome, <a href="https://www.onlinegdb.com/profile/" style="color:white; font-size:inherit"><b>Sibasish Badatya</b></a>
          ...
          <ul class="nav nav-tabs nav-stacked text-center" style="background-color: #337ab7; border-bottom:1px solid #658a9e">
                ...
                <li id="navbar-ide"><a href="https://www.onlinegdb.com/">Create New Project</a></li>
...
<center>
    ...
    <script async="" type="text/javascript" src="./loc que_files/carbon.js.download" id="_carbonads_js"></script> 
...
<script src="./loc que_files/jquery.dataTables.min.js.download" defer=""></script>
<link rel="stylesheet" href="./loc que_files/jquery.dataTables.min.css">

<script src="./loc que_files/dataTables.rowReorder.js.download" defer=""></script>

<iframe id="my_iframe" style="display:none;" src="./loc que_files/saved_resource.html"></iframe>
<script>
...
<div class="well">
    <div class="row" style="min-height:75vh; padding-left:40px; font-size:17px;">
<div class="list-group col-sm-10 col-sm-offset-1">
    <h3 id="my_project_title_wrapper">
        
        <a href="https://www.onlinegdb.com/myfiles" id="title_my_projects" data-id="0">My Projects</a>
        
        
    </h3>
    <hr>
    
    <span id="project_btn_wrapper">
        <a class="btn btn-success" id="btn_new_project" href="https://www.onlinegdb.com/"><span class="glyphicon glyphicon-credit-card"></span> New Project</a>
        <button class="btn btn-success" id="btn_new_folder"><span class="glyphicon glyphicon-folder-open"></span> New Folder</button>
        <a class="btn btn-success" id="btn_open_trash" href="https://www.onlinegdb.com/myfiles/bin"><span class="glyphicon glyphicon-trash"></span> Bin </a>
    </span>
    
    <table class="hide">
        <tbody id="new_folder_row_template">
            <tr data-uid="{project_uid}" id="row_{project_id}" data-id="{project_id}" dt-row-droppable="true">
                <td><span class="grippy"></span> </td>
                <td><a href="https://www.onlinegdb.com/myfiles/%7Bproject_uid%7D" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">{project_name}</a></td>
                <td>Folder</td>
                <td>
                    <button class="btn" style="padding:1px; background-color: transparent;" onclick="renameProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Rename"><span class="glyphicon glyphicon-edit"></span></button>
                    <button class="btn" style="padding:1px 5px; background-color: transparent;" onclick="deleteProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Delete"><span class="glyphicon glyphicon-trash"></span></button>
                </td>
            </tr>
        </tbody>
    </table>
    
            <div id="project_list_wrapper" class="dataTables_wrapper no-footer"><div id="project_list_filter" class="dataTables_filter"><label>Search:<input type="search" class="" placeholder="" aria-controls="project_list"></label></div><table id="project_list" class="display dataTable no-footer" style="width: 100%; position: relative;" role="grid" aria-describedby="project_list_info">
        <thead>
            <tr role="row"><th class="sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 15px;"></th><th class="sorting" tabindex="0" aria-controls="project_list" rowspan="1" colspan="1" aria-label="Name: activate to sort column ascending" style="width: 449px;">Name</th><th class="sorting" tabindex="0" aria-controls="project_list" rowspan="1" colspan="1" aria-label="Type: activate to sort column ascending" style="width: 68px;">Type</th><th class="sorting_disabled" rowspan="1" colspan="1" aria-label="Action" style="width: 166px;">Action</th></tr>
        </thead>
        <tbody>
        ...
        <tr data-uid="mZAKbGjrQ" id="row_19502190" data-id="19502190" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/mZAKbGjrQ" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">first.html</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px 5px; background-color: transparent;" onclick="downloadProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Download"><span class="glyphicon glyphicon-download-alt"></span></button>
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="shareProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Share/Embed Project"><span class="glyphicon glyphicon-share"></span></button>
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
    
    
    </td>
            </tr><tr data-uid="OfyfhpsuKm" id="row_19511736" data-id="19511736" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/OfyfhpsuKm" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">MINT.HTML</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="OmAoBn9iCm" id="row_19513591" data-id="19513591" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/OmAoBn9iCm" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">MINT.HTML</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="RSVI91SFqw" id="row_19617197" data-id="19617197" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/RSVI91SFqw" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">sibasis.html</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="DvtbyJbSL" id="row_19618335" data-id="19618335" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/DvtbyJbSL" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project"></a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="omwvzuMmF" id="row_19847347" data-id="19847347" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/omwvzuMmF" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">INDIAN CRICKET TEAM</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="v11WF309t" id="row_19848721" data-id="19848721" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/v11WF309t" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">Forked from INDIAN CRICKET TEAM</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="tqdkB-Fii" id="row_19849964" data-id="19849964" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/tqdkB-Fii" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">Forked from Forked from INDIAN CRICKET TEAM</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="crsUfRYmzt" id="row_19901625" data-id="19901625" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/crsUfRYmzt" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">ict</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="LXtBy0M-8" id="row_19991597" data-id="19991597" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/LXtBy0M-8" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">india vs srilanka</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="l6jkMgzbe" id="row_19999582" data-id="19999582" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/l6jkMgzbe" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">Forked from india vs srilanka</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="rzb4qdyPZE" id="row_20167799" data-id="20167799" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/rzb4qdyPZE" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">fg</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="VBFEdGNIY" id="row_20310478" data-id="20310478" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/VBFEdGNIY" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">login form</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="cq0rgCa9D" id="row_20333100" data-id="20333100" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/cq0rgCa9D" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">Forked from login form</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="yxGAqEJxV" id="row_20663446" data-id="20663446" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/yxGAqEJxV" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">lift off c week 1 que4</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="A8MQAxVD3" id="row_20669719" data-id="20669719" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/A8MQAxVD3" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">lift off c week 1 que5</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="ZxBP-c9mV" id="row_20669775" data-id="20669775" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/ZxBP-c9mV" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">lift off c week 1 que5</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="aGw7Je-pp" id="row_20669787" data-id="20669787" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/aGw7Je-pp" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">lift off c que 5</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="nvoSuZKAT" id="row_20670551" data-id="20670551" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/nvoSuZKAT" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project" aria-describedby="tooltip892007">lift off c que 1</a><div class="tooltip fade top" role="tooltip" id="tooltip892007" style="top: 773.125px; left: 54.4375px; display: block;"><div class="tooltip-arrow" style="left: 50%;"></div><div class="tooltip-inner">open this project</div></div></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="h6y_oR3zG" id="row_20671411" data-id="20671411" role="row" class="even">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/h6y_oR3zG" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">que2</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
            ...
            </tr><tr data-uid="x0jmthcSS" id="row_20671558" data-id="20671558" role="row" class="odd">
                <td><span class="grippy"></span>  </td>
                <td><a href="https://www.onlinegdb.com/edit/x0jmthcSS" class="project_name" style="color:black;font-size:14px;" title="" data-toggle="tooltip" data-original-title="open this project">que3</a></td>
                <td>Project</td>
                <td>
    ...
    <button class="btn" style="padding:1px; background-color: transparent;" onclick="forkProject(this);return false;" title="" data-toggle="tooltip" data-original-title="Fork Project"><span class="glyphicon glyphicon-duplicate"></span></button>
        ...
        </table><div class="dataTables_info" id="project_list_info" role="status" aria-live="polite">Showing 1 to 21 of 21 entries</div></div>
</div>
      </div>
</div>
...
var project_uid  = null; // Required for saveCode to work
var dt = null;

function move_snippet(snippet_uid, folder_id, callback){
    
    shareCode(false, {move_snippet: true, callback:callback,
        uid:snippet_uid,
    parent_id : (folder_id>0 ? folder_id: null)});
}
...
$(document).ready(function() {
    ...
    dt = $('#project_list').DataTable({paging: false, 
        rowReorder: {
        snapX: false,
    },"order": [], "columns": [ { "orderable": false }, null, null,{ "orderable": false } ]});
    dt.on('row-reorder-dropped', function(e, details, edit){
        var moving_row = dt.row(edit.triggerRow);
        var drop_target_row = dt.row(edit.dropRow);
        var moving_row_id = moving_row.id();
        var drop_target_row_id = drop_target_row.id();
        //moving_row.remove();
        //dt.draw();
        //ajax api to move project/directory to directory

        var project_uid = $("#"+moving_row_id).attr("data-uid");
        var folder_id = $("#"+drop_target_row_id).attr("data-id");
        var on_snippet_moved = function(data){
            moving_row.remove();
            dt.draw();
        }
        move_snippet(project_uid, folder_id, on_snippet_moved);
    })

    

    $("#btn_new_folder").on('click', on_new_folder);

    $("#project_name").keypress(function(event){
        var key = event.which;
        if(key == 13){
            event.preventDefault();
            shareCode(false, {new_folder: true, parent_id:get_parent_folder_id() , callback:on_project_added});
            return false;
        }
    });
});

function on_project_added(data){
    var row_template = $("#new_folder_row_template").html();
    var project = data;
    var html = tmpeng(row_template, {project_uid:data.uid, project_id: data.id, project_name:data.name});
    dt.row.add($(html )).draw(false);
}

function on_new_folder(){
    saveCode({new_folder: true, parent_id:get_parent_folder_id(), callback:on_project_added})
}

function get_ProjectUID(obj){
    return $(obj).parent().parent().attr('data-uid');
}
function get_ProjectName(obj){
    return $(obj).parent().parent().find('.project_name').text();
}
function set_ProjectName(obj, name){
    return $(obj).parent().parent().find('.project_name').text(name);
}

function handle_edit_file_input(e, opts){
    var pid = opts.pid;
    var obj = opts.obj;

    //console.log("handle_edit_file_input:");
    ...
    $.ajax({
            ...
            url: '/rename/'+pid+'?newfilename='+filename,
            success: function(data) {
                //console.log(data);
                if(data.result=="LOGIN_ERROR"){
                    resetLogin(); renameProject(obj);
                }else if(data.result=="OK"){
                    set_ProjectName(obj, filename);
...
var rename_project_obj=null;
function rename_project_callback(){
    renameProject(rename_project_obj);
}
function renameProject(obj){
    var project_name = get_ProjectName(obj);
    var pid = get_ProjectUID(obj);
    rename_project_obj =  obj;
    if(popUpLogin("Please login to rename project", rename_project_callback)) return;
    g_renamefilemodal_popup({default_name:project_name, title:"Rename Project"},
    handle_edit_file_input,{pid:pid, obj:obj});
}

function downloadProject(obj){
    $(obj).attr('disabled',true);
    var uid = get_ProjectUID(obj);
    Download('/download/'+uid);
    $(obj).attr('disabled',false);
}

function forkProject(obj){
    var uid = get_ProjectUID(obj);
    window.location.href="/fork/"+uid;
}
...
function shareProject(obj){
    ...
    $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: '/shareProject/'+uid,
            success: function(data) {
                if(data.result=="LOGIN_ERROR"){
                    resetLogin(); shareProject(obj);
                }else if(data.result=="OK"){
                    share_code_snippet_modal(uid, 'S', 
                    'Project is shared on below public link.<br\> Any changes made to your project will be visible in this link.');
                    $(obj).attr('disabled',false);
                }else{
                    $(obj).attr('disabled',false);
                }
...
function restoreProject(obj){
    deleteProject(obj, {restore:true});
}

function deleteProjectPermanently(obj){
    deleteProject(obj, {perm_delete:true});
}

var delete_project_obj = null;
var delete_project_opt = false;

function delete_project_callback(){
    deleteProject(delete_project_obj, delete_project_opt);
}
function deleteProject(obj, opt){
    delete_project_obj =  obj;
    delete_project_opt = opt;
    var perm_delete = opt?opt.perm_delete:false;
    var restore = opt?opt.restore:false;
    
    $(obj).attr('disabled',true);
    var uid = get_ProjectUID(obj);
    var project_name = get_ProjectName(obj);
    //console.log("Delete project");
    var popUpMsg = "Please login to delete project/folder";

    if(restore) popUpMsg = "Please login to restore project/folder";

    if(popUpLogin(popUpMsg, delete_project_callback)) return;

    var r = false;
    
    if(restore){ r = true;
    }else {
        r =confirm("Are you sure you want to delete project `"
    +project_name+"` "+(perm_delete?"permanently":"")+"?");
    }

    var params = "?";
    if(perm_delete) params +="&perm_delete=true";
    ...
    if (r == true) {
        $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: '/delete/'+uid+params,
            success: function(data) {
                console.log(data);
                if(data.result=="LOGIN_ERROR"){
                    resetLogin(); delete_project_callback();
                }else if(data.result=="OK"){
                    ...
                    <div class="omb_login">
                        <h3 class="omb_authTitle">Login with
                            ...
                            <div class="row omb_row-sm-offset-31 omb_socialButtons">
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/myfiles#" onclick="login(&#39;googleplus&#39;)" class="btn btn-lg btn-block omb_btn-google">
                                        <i class="fa fa-facebook visible-xs"></i>
                                        <span class="hidden-xs">Google+</span>
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/myfiles#" onclick="login(&#39;facebook&#39;)" class="btn btn-lg btn-block omb_btn-facebook">
                                        <i class="fa fa-twitter visible-xs"></i>
                                        <span class="hidden-xs">Facebook</span>
                                    </a>
                                </div>
                                <div class="col-xs-4">
                                    <a href="https://www.onlinegdb.com/myfiles#" onclick="login(&#39;github&#39;)" class="btn btn-lg btn-block omb_btn-github">
...
<script async="" src="./loc que_files/js(1)"></script>
<script>
  ...
  gtag('config', 'UA-79897653-2', {'user_id': '5024640'});
...
<script type='text/javascript'>
    window.__wtw_lucky_site_id = 208258;
...
-->
        <!-- Go to www.addthis.com/dashboard to customize your tools --> <script type="text/javascript" src="./loc que_files/addthis_widget.js.download"></script><div id="_atssh" style="visibility: hidden; height: 1px; width: 1px; position: absolute; top: -9999px; z-index: 100000;"><iframe id="_atssh228" title="AddThis utility frame" style="height: 1px; width: 1px; position: absolute; top: 0px; z-index: 100000; border: 0px; left: 0px;" src="./loc que_files/sh.f48a1a04fe8dbf021b4cda1d.html"></iframe></div><style id="service-icons-0"></style> 
...
<iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame" src="./loc que_files/box-acca23410e696f2ca3087d947271c3d0.html" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe></body></html>